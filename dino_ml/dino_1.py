...
class Dinosaur:
    ...
    def __init__(self, img=RUNNING[0]):
        ...
        self.rect = pg.Rect(self.X_POS, self.Y_POS, img.get_width(), img.get_height())
    ...
    def draw (self, SCREEN):
        ...
        pg.draw.rect(SCREEN, self.color, (self.rect.x, self.rect.y, self.rect.width, self.rect.height), 2)
        for obstacle in obstacles:
            pg.draw.line(SCREEN, self.color, (self.rect.x + 54, self.rect.y + 12), obstacle.rect.center, 2)
...
def eval_genomes(genomes, config):
    ...
    def stats():
        ...
        text_2 = FONT.render(f'Genaration:  {p.generation + 1}', True, (0, 0, 0))
...
if __name__ == "__main__":
    ...
    config_path = os.path.join(local_dir, 'dino_config.txt')
